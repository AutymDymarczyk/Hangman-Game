...
import random
words = ["werm", "pickles", "arthritis", "law", "calculus", "forest", "joe", "guitar"]
...
# redefined with the user's newest guess.

    dashes = update_dashes(secret_word, dashes, newguess)

# This part of the while loop prints whether the
# user's guess was in the secret word or not,
# and subtracts a guess from the variable guesses_left
...
# This if - else statement ends the game after the
